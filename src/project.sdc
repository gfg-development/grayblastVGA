...
set idx [ lsearch $all_inputs_wo_clk "uio_in\[5\]" ]
...
#  uio_in[5]   clock is used for the GPU cores
create_clock [ get_ports "uio_in\[5\]" ]  -name core_clk -period $::env(CLOCK_PERIOD)
set_input_delay $input_delay_value -clock [ get_clocks core_clk ] $all_inputs_wo_clk
...
# clk  and  core_clk  are mesochronous, and they never interact
set_clock_groups -asynchronous -group { clk } -group { core_clk }
